...
const objets = [

  {
    ...
    description: "Grâce sa ligne de toit spécifique et ses feux avant à LED, la Nissan MICRA combine le côté pratique d’une citadine à un design d’avant-garde et au souci du détail.",
    more: "learn more",
    del_Item: "delete", 
  ...
  },
  {
    ...
    description: "L'Alfa Romeo Stelvio Quadrifoglio incarne un mélange parfait de puissance et de technologie. Le moteur monobloc en aluminium 2.9 V6 Bi-Turbo de 510 ch est associé au système de transmission à quatre roues motrices Q4.",
    more: "learn more",
    del_Item: "delete", 
  ...
  },
  {
    ...
    description: "Vous savez peut-être déjà que Chevrolet va prochainement mettre un terme à son opération de vente de nouvelles voitures en Europe. Toutefois, nos réparateurs agréés continueront de fournir leurs services et l’entretien de véhicules à tous nos clients. De plus, avec l’appui d’Opel, notre marque partenaire GM en Europe, nous pouvons continuer de vous assister pour trouver le véhicule de vos rêves.",    
    more: "learn more",
    del_Item: "delete", 
  ...
  },
  {
    ...
    annee: "Année : 2023",
    origine : "Origine Italienne",
    description: "Juste avant le 60e anniversaire de la marque, Lamborghini a dévoilé la Revuelto, la première supersportive hybride HPEV (High Performance Electrified Vehicle). Avec la Revuelto, Lamborghini établit une nouvelle référence en matière de performances, de technologie embarquée et de plaisir de conduire.",
    more: "learn  more",
    del_Item: "delete", 
  ...
  },
  {
    ...
    annee: "Année : 2023",
    origine : "Origine Japonaise",
    description: "Élaborée par nos maîtres concepteurs japonais, la All-New Mazda CX-60 reflète tout ce que Mazda a intégré dans son ADN au cours des 100 dernières années. L'architecture puissante est dotée d'une transmission intégrale pour la sportivité, ainsi que d'une série de nouvelles technologies centrées sur le conducteur. Découvrez l'élégance qui reflète notre héritage japonais dans le showroom en ligne.",
    more: "learn more",
    del_Item: "delete", 
  ...
  },
  {
    ...
    description: "An extreme McLaren design concept born in the virtual racing world.Now made real. And ultra-rare. There will only ever be 25 Solus GTs. Rendered possible through McLaren’s position at the apex of motorsport, supercar and hypercar development – this is a pure expression of track driving focus and engagement. ",
    more: "learn more",
    del_Item: "delete", 
  ...
  },
  {
    ...
    annee: "Année : 2023",
    origine : "Origine Allemagne",
    description: "La conduite d'une Porsche vous permet de gouter à des performances exaltantes avec un sentiment permanent de perfection et de fiabilité. Avec la garantie Porsche Approved, vous pourrez apprécier durablement l'exaltation et la tranquillité d'esprit du premier jour.",
    more: "learn more",
    del_Item: "delete", 
  ...
  },
  {
    ...
    annee: "Année : 2023",
    origine : "Origine japonaise",
    description: "A la recherche d'une nouvelle voiture électrique pour la nouvelle année ? Découvrez la Subaru Solterra Nombre très limité de voitures de stock disponibles en Belgique",
    more: "learn more",
    del_Item: "delete", 
  ...
  },
  {
    ...
    annee: "Année : 2023",
    origine : "Origine japonaise",
    description: "Vous pensiez que vous étiez obligés de passer à l'électrique ? Re-pensez-y ! Rouler en Toyota hybride est souvent la solution la plus intéressante pour les professionnels. Avec la Toyota Yaris Cross, vous n'économisez pas seulementquand vous l'achetez, mais aussi quand vous roulez.",
    more: "learn more",
    del_Item: "delete", 
  ...
  },
  {
    ...
    annee: "Année : 2023",
    origine : "Origine Italienne",
    description: "Lorsque Ferrari construit un nouveau modèle, la tâche première et la plus difficile pour le constructeur basé à Maranello est de se surpasser une fois de plus. La tâche devient d'autant plus grande lorsqu'un nouveau moteur 12 cylindres doit être construit pour cela. ",
    more: "learn more",
    del_Item: "delete", 
